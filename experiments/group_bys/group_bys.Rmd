...
The goal is to see which one is simpler to use in each cases. Time benchmarks are done very often of several
data analysis libraries, like dplyr, data.table, pandas, dask, etc. What is less common is to see how the API of these libraries compare and I think this is key when choosing one of them.
...
In this case, dplyr is the clear winner since both in python and SQL it is overly complicated to calculate this.
